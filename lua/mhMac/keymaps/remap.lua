...
vim.keymap.set("i", "<C-D><C-D>","{}",{noremap=true,silent=true})
vim.keymap.set("i", "<C-D><C-E>","{}<Esc>i",{noremap=true,silent=true})
vim.keymap.set("i", "<C-D><C-F>","()",{noremap=true,silent=true})
vim.keymap.set("i", "<C-D><C-R>","()<Esc>i",{noremap=true,silent=true})
vim.keymap.set("i", "<C-D><C-J>","<>",{noremap=true,silent=true})
vim.keymap.set("i", "<C-D><C-U>","<><Esc>i",{noremap=true,silent=true})
vim.keymap.set("i", "<C-D><C-K>","[]",{noremap=true,silent=true})
vim.keymap.set("i", "<C-D><C-I>","[]<Esc>i",{noremap=true,silent=true})
